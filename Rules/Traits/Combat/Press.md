...
Actions with this trait allow you to follow up earlier attacks. Some actions with the press trait also grant an effect on a failure.

## Mechanical Rules

- An action with the press trait can be used only if you are currently affected by a multiple attack penalty.
- You can’t use a press action when it’s not your turn, even if you use the Ready activity.  
