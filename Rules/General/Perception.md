...
See: [[Rules/Environment/Sensory/Detection|Detection]] and [[Senses]].


Whenever you need to attempt a check based on your awareness, you'll attempt a Perception check. Your Perception uses your [[Wisdom]] modifier, so you'll use the following formula when attempting a Perception check.
...
| ----- | ----------------------- | ------------- | --------- |
| 3     | [[Thorough Search]]   | Expert | You take your time searching to ensure you find everything. |
| 7     | [[Expeditious Search]]| Master | Doubles all searching speed caps (Including Thorough Search) |
