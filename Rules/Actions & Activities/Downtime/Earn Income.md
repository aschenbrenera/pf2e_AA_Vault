...
**Description:** You can use a skill to earn money during downtime. 

**Skill:** [[Crafting]], [[Lore]], [[Performance]] (Trained)

This takes time to set up, and your income depends on your proficiency rank and how lucrative a task you can find. Because this process requires a significant amount of time and involves tracking things outside the progress of adventures, it won't come up in every campaign.  
...
## Mechanical Rules
 ...
 - You use one of your skills to make money during downtime. You must be trained in the skill to do so.
 - If you're using a skill other than Crafting, Lore, or Performance, the DC tends to be significantly higher.
 -  The GM assigns a task level representing the most lucrative job available.
	 - You can search for lower-level tasks, with the GM determining whether you find any. Sometimes you can attempt to find better work than the initial offerings, though this takes time and requires using [[Gather Information]], doing some research, or socializing.  
...
| -------------------- | ------ | ----------------------------------------------------------------------------------- |
| Trained              | 15     | bartend, do legal research                                                                   |
| Expert               | 20     | curate drink selection, present minor court cases                                                |
| Master               | 30     | run a large brewery, present important court cases                                              |
| Legendary            | 40     | run an international brewing franchise, present a case in Hell’s courts |
