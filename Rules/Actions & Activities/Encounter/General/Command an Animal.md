...
[Concentrate](Concentrate.md "Action & Ability Trait") [Auditory](Auditory.md "Effect Trait") 
**Description:** You issue an order to an animal. If you have a [[Pet]], [[Animal Companion]], [[Familiar]], or similar [[Minion]], you can command it much more effectively.
...
- Follows the rules for the `Auditory` trait.
