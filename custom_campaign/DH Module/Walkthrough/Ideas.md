...
Use the ghost statistics in the Monster Manual, with the following modifications:
...
Slot 1: Rogue(Thief) or Investigator(Detective) (Velma)
Slot 2: Cleric (of Pharasma) or Witch (Spinner of Threads - Pharasma) (Daphne)
Slot 3: Barbarian (Spirit - Ancestor Warrior) or Champion (Redeemer or Liberator) (Shaggy)
Slot 4: Fighter or Ranger (Two-Weapon Flurry) (Fred)

Level 1 to Level 3

Mysterium Inc.

##  FINAL PARTY OVERVIEW: MYSTERY INC. REIMAGINED

### 🔮 **Velma Dinkley** – _Spinner of Threads Witch_

- **Role**: Occult researcher, diviner, debuffer, and magical analyst.
    
- **Combat**: Backline controller and utility caster.
    
- **Skills**: Occultism, Arcana, Society, Recall Knowledge expert.
    
- **Tone**: The brains of the operation, armed with ancient tomes and a sharp tongue.
    

---

### 🛡️ **Fred Jones** – _Champion (Liberator Cause)_

- **Role**: Party tank, moral compass, protector.
    
- **Combat**: Frontline defense, reaction-based protection, Lay on Hands healing.
    
- **Skills**: Diplomacy, Athletics, Intimidation.
    
- **Tone**: The team’s knight in shining armor — brave, organized, maybe a little dramatic.
    

---

### 🐾 **Shaggy Rogers** – _Beastmaster Ranger (Scooby the companion)_

- **Role**: Midline striker, tracker, survivalist.
    
- **Combat**: Melee or ranged, aided by Scooby in flanking and disruption.
    
- **Skills**: Survival, Nature, Stealth, Perception.
    
- **Tone**: The reluctant hero with a powerful bond to Scooby, who’s always hungry but surprisingly effective under pressure.
    

---

### 🔥 **Daphne Blake** – _Elemental Sorcerer (Fire Bloodline)_

- **Role**: Backline blaster, socialite, wildcard.
    
- **Combat**: Ranged AoE specialist with high burst potential.
    
- **Skills**: Diplomacy, Performance, Society.
    
- **Tone**: Elegant and fierce — refined manners, but don’t stand too close when the fire starts.