...
# Duskwood
 ...
 [Uncommon](Uncommon.md "Uncommon Rarity Trait") [Precious](Precious.md "Item Trait") 
...
Bulk is reduced by 1 (or to light Bulk if its normal Bulk is 1, with no effect on an item that normally has light Bulk)
...
[Duskwood Weapon](https://2e.aonprd.com/Equipment.aspx?ID=2858)
